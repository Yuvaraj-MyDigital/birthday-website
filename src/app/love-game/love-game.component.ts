...
export class LoveGameComponent {
  ...
  scenarios: Scenario[] = [
    {
      text: "Joshika, I still remember the first time I saw you. Time stood still. Your smile—it was like the dawn breaking over a dark sky. I knew in that moment my life had changed forever. From friends to something more, every word we exchanged wove us closer. Do you remember how easily we could talk for hours? How your laugh felt like the sweetest melody I’d ever heard?",
